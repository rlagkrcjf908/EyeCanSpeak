...
public class DrawController {
    ...
    public ResponseEntity<?extends BaseResponseBody> upload(@RequestPart(value = "data") DrawPostReq drawPostReq, @RequestPart(value="File")MultipartFile multipartFile){
        try{

            AwsS3 awsS3 = drawService.upload(drawPostReq,multipartFile,"upload");
            if(awsS3 != null) {
